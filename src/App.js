      ...
      <div className="App list-group-item justify-content-center align-items-center mx-auto" style={{"width": "400px", "backgroundColor": "white", "marginTop": "15px"}}>
        ...
        <div className="card-body">
          ...
          <span className="card-text">
            <input type="text" 
            onChange={event => setTitle(event.target.value)} className="mb-2 form-control titleIn" placeholder='Title' />
            <input type="text"
            onChange={event => setDesc(event.target.value)} className="mb-2 form-control desIn" placeholder='Description' />
            <button className="btn btn-outline-primary mx-2 mb-2 mb-3" style={{'borderRadius': '50px', "font-weight": "bold"}}
